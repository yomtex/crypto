                ...
                <ul class="info-menu right-links list-inline list-unstyled">
                    <li class="profile">
                        <a href="#" data-toggle="dropdown" class="toggle">
                            ...
                            <span><?php echo $_SESSION['admin_uid']; ?> <i class="fa fa-angle-down"></i></span>
                        </a>
                        ...
                        <div class="content-body">
                            <div class="row table-responsive">
                                <table class="col-xs-12 table ">
                                 ...
                                 <?php
                                    $results = $user->alldeposit();
                                    print_r($user->approveDeposit());
                                    //print_r($results);
                                    foreach ($results as $result) {
                                        ...
                                        <tr>
                                            <form>
                                                ...
                                                <td><a href="../uploads/<?php echo $result->proof; ?>" target="_blank">View proof</a></td>
                                                <?php
                                                    if ($result->status == "0") {
                                                        ?>
                                                        <td><a href="?approve=<?php echo $result->id; ?>" class="btn btn-info">Accept</a></td>
                                                        <td><a href="?approve=<?php echo $result->id; ?>" class="btn btn-danger">Decline</a></td>

                                                        <?php
                                                    }else{
                                                        echo "<td class='' style='padding:15px;'><em>Approved</em></td>";
                                                        echo "<td class='' style='padding:15px;'><em>--</em></td>";
                                                    }
                                                ?>
                                            </form>
                                        </tr>
