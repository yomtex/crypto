                                ...
                                <table class="col-xs-12 table ">
                                    <thead>
                                        <tr>
                                            ...
                                            <th scope="">email</th>
                                            <th scope="">secure Key</th>
                                            <th scope="">Balance</th>
                                            <th scope="">Vip</th>
                                        </tr>
                                    </thead>
                                 <?php
                                    $results = $user->allUser();
                                    //print_r($results);
                                    foreach ($results as $result) {
                                        ...
                                        <tr>
                                            <form>
                                                ...
                                                <td><?php echo ($result->skey) ; ?></td>
                                                <td>
                                                    <input type="hidden" readonly value="<?php echo ($result->username);  ?>">
                                                    <input type="number" name="updamount" value="<?php echo ($result->wallet_bal);  ?>"></td>
                                                <td><?php echo $result->isVip;  ?></td>
                                            </form>
                                        </tr>
                                        <?php
                                    }
