    ...
    <div class="page-container row-fluid container-fluid">
        ...
        <section id="main-content" class=" ">
                                ...
                                <div class="well col-xs-12" style="background-color: ;">
                                    <?php
                                                ...
                                                foreach ($results as $result) {
                                                   ...
                                                   //get sender 
                                                   if($tr_type == "transfer" && $receiver !=self){
                                                       //filter receiver and //sender         
            ...
            <img src='../assets/images/transfer.png' style='width:30px;'><span style='font-size:12px; float:right;'>
                ...
                $result->datePosted
            </span>&nbsp;&nbsp; "." ". ($result->receiver[0].$result->receiver[1]."****".$result->receiver[-1]) ."<br><span style='padding-left:45px; font-size:12px;'>Transfer</span><br>
            </div>";
                                                        //echo "Debit $receiver  $amount<br>";
                                                       }else{
                                                            echo "<div class='well' style='padding:5px; margin:4px;'>
            <img src='../assets/images/deposit.png' style='width:30px;'><span style='font-size:12px; float:right;'>
                <span style='color:orange;'>$result->amount.00 USDT</span><br>
                $result->datePosted
            </span>&nbsp;&nbsp; "." ". ($result->sender[0].$result->sender[1]."****".$result->sender[-1]) ."<br><span style='padding-left:45px; font-size:12px;'>Credited</span><br>
            </div>";
                                                         //echo "Credit $sender $amount<br>";
                                                       }
                                                   }else{
                                                        if ($tr_type =="deposit" && $sender == $_SESSION["uid"]) {
            echo "<div class='well' style='padding:5px; margin:4px;'>
            <img src='../assets/images/deposit.png' style='width:30px;'><span style='font-size:12px; float:right;'>
                <span style='color:orange;'>$result->amount.00 USDT</span><br>
                $result->datePosted
        ...
        }elseif ($tr_type =="withdraw" && $sender == $_SESSION["uid"]) {
            echo "<div class='well' style='padding:5px; margin:4px;'>
        ...
        }elseif ($tr_type =="upgrade" && $sender == $_SESSION["uid"]) {
            echo "<div class='well' style='padding:5px; margin:4px;'>
