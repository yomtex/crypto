                ...
                <div class="col-xs-12 col-lg-12">
                    <section class="box" style="border-left: 3px solid #e77512;">
                        <header class="panel_header">
                            <h2 class="title pull-left">Transfer</h2>
                        ...
                        <div class="content-body">
                            ...
                            <form action="" method="post">
                                ...
                                <br>
                                <div class="row">
                                    <div class="col-xs-3">Account Username</div>
                                    <div class="col-xs-9">
                                        <input type="text" class="form-control" placeholder="Receiver requires at least VIP" name="receiver">
                                    </div>
                                </div>
                                <br>
                                <div class="row">
                                    ...
                                    <div class="col-xs-10">
                                        <input type="text" required  name="amount" class="form-control" placeholder="Transfer amount">
                                    </div>
                                </div>
                                <br>
                                <div class="row">
                                    ...
                                    <div class="col-xs-10">
                                        <input type="text" readonly  name="fee" value="0" class="form-control">
                                    </div>
                                </div>
                                <br>
                                <p><input type="submit" style="font-size:12px;" class="btn btn-primary  form-control"  name="transfer" value="ONE-CLICK TRANSFER WITHOUT KEYS"></p>
                            </form>
                        </div>
                    </section>
                </div>
